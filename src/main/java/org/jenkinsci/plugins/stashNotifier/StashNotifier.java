...
public class StashNotifier extends Notifier {
  ...
  /** cookies pass for authentication with Stash build API. */
  private final String stashCookie;
  ...
  public static final class DescriptorImpl
    ...
    public FormValidation doCheckStashUserName(@QueryParameter String value)
      ...
      if (value.trim().equals("")
          && (stashCookie == null || "".equals(stashCookie.trim()))
    ...
    public boolean configure(
      ...
      stashCookie =
          formData.getString("stashCookie");
      stashRootUrl =
  ...
  private HttpPost createRequest(
    ...
    if (("".equals(pwd) || pwd == null) && descriptor.getStashPassword() != null)
      pwd = descriptor.getStashPassword().getPlainText();
    if ("".equals(cookie) || cookie == null)
      cookie = descriptor.getStashCookie();
